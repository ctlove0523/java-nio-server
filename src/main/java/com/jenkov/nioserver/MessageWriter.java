...
public class MessageWriter {
    ...
    public void write(Socket socket, ByteBuffer byteBuffer) throws IOException {
        byteBuffer.put(this.messageInProgress.getSharedArray(), this.messageInProgress.getOffset() + this.bytesWritten, this.messageInProgress.getLength() - this.bytesWritten);
        byteBuffer.flip();
